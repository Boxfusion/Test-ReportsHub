...
test.describe('ELEAVE-OVERRIDE — Override Dialog', () => {
  ...
  test("TC-02: System should override the decision to approve without pay when 'Ok' button is clicked", async ({ page }) => {
  ...
  test("TC-03: Status should change to 'Approved With Full Pay' when 'Ok' button is clicked", async ({ page }) => {
    test.skip(true, "Requires a leave application parked at the relevant workflow step; submit actions would also mutate live QA data - not recorded in this read-only run");
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-override-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-override-dialogbox
  ...
  test("TC-04: User should be redirected to the Home page when 'Ok' button is clicked", async ({ page }) => {
    test.skip(true, "Requires a leave application parked at the relevant workflow step; submit actions would also mutate live QA data - not recorded in this read-only run");
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-override-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-override-dialogbox
  ...
  test("TC-05: When a user clicks on the 'Close' button, the system should close the dialog", async ({ page }) => {
    test.skip(true, "Requires a leave application parked at the relevant workflow step; submit actions would also mutate live QA data - not recorded in this read-only run");
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-override-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-override-dialogbox
  ...
  test("TC-06: When a user clicks on the 'Close' button, the system should display the leave application details", async ({ page }) => {
    test.skip(true, "Requires a leave application parked at the relevant workflow step; submit actions would also mutate live QA data - not recorded in this read-only run");
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-override-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-override-dialogbox
