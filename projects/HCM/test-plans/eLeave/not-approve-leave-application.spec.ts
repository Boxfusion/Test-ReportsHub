...
test.describe('ELEAVE-NOT-APPROVE — Not Approve Leave Application Dialog', () => {
  ...
  test.fixme("TC-02: Change status to 'Declined' when 'Ok' button is clicked", async ({ page }) => {
  ...
  test.fixme("TC-03: Redirect user to Home page when 'Ok' button is clicked", async ({ page }) => {
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // STEP 2: CLICK Open the eleave-wf-notapproveleaveapplication-dialogbox
  ...
  test.fixme("TC-04: Close button should close the dialog", async ({ page }) => {
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // STEP 2: CLICK Open the eleave-wf-notapproveleaveapplication-dialogbox
  ...
  test.fixme("TC-05: Close button should display leave application details", async ({ page }) => {
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // STEP 2: CLICK Open the eleave-wf-notapproveleaveapplication-dialogbox
  ...
  test.fixme("TC-06: The system should not allow a user to not approve a leave application without populating comments", async ({ page }) => {
    await loginAsAdmin(page);
    // STEP 1: SNAPSHOT — confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // SNAPSHOT: confirm the target element for: Open the eleave-wf-notapproveleaveapplication-dialogbox
    // STEP 2: CLICK Open the eleave-wf-notapproveleaveapplication-dialogbox
