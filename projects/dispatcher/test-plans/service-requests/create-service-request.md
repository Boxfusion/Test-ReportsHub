...
| Field | Value |
|-------|-------|
| App URL | https://linux-lesedi-dep-adminportal-test.azurewebsites.net/ |
| Environment | Test |
| Login As | admin / 123@Qwee |

## Objective
> Validate that an admin user can log in to the Dispatcher portal, navigate to Service Requests, open the create form, fill the mandatory fields, submit the request, and see a success confirmation.

## Preconditions
- [ ] App is reachable at https://linux-lesedi-dep-adminportal-test.azurewebsites.net/
- [ ] Admin credentials are valid (admin / 123@Qwee)
...
- **Type:** Happy path
- **Steps:**
  1. NAVIGATE to https://linux-lesedi-dep-adminportal-test.azurewebsites.net/
  2. SNAPSHOT — confirm login form is visible
  3. TYPE username field with `admin`
  4. TYPE password field with `123@Qwee`
