...
- Name: projects/EC-DEDEA-Bid-Management/test-plans/tender-process/ecdedea-tender-process.spec.ts >> ECDEDEA-TP — EC DEDEA Bid Management (Tender Process) >> TC-02: Review and Approve Tender Details
- Location: projects/EC-DEDEA-Bid-Management/test-plans/tender-process/ecdedea-tender-process.spec.ts:467:7
...
Locator: getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Review and Approve' }).first()
Expected: visible
Timeout: 30000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Review and Approve' }).first() with timeout 30000ms
  - waiting for getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Review and Approve' }).first()
  ...
  - table:
    - row "Ref No Initiator Type Name Action Required Received Date Target Date Status":
      ...
      - columnheader "Status":
        ...
        - separator
    - rowgroup:
      - row "search SP:2026/02375 Mhloti Mabuza Sundry Payments Reversals Upload Payment Stub 01/09/2026 In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=1738dc49-ec32-4a35-a260-ad8c3c03949b&todoid=0b8338ab-e4fa-4f0c-89d2-3a8f6c6b1129
            - img "search"
        - cell "SP:2026/02375"
        - cell "Mhloti Mabuza"
        - cell "Sundry Payments"
        - cell "Reversals"
        - cell "Upload Payment Stub"
        - cell "01/09/2026"
        - cell
        - cell "In Progress"
      - row "search SP:2026/02257 Thabiso Maake Sundry Payments Reversals Complete BAS Details 01/09/2026 In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=99cd0031-5e84-4cc8-a080-0e18657580e8&todoid=5bc4d4c4-b748-4d85-adc0-7aad3ec38281
            - img "search"
        - cell "SP:2026/02257"
        - cell "Thabiso Maake"
        - cell "Sundry Payments"
        - cell "Reversals"
        - cell "Complete BAS Details"
        - cell "01/09/2026"
        - cell
        - cell "In Progress"
      - row "search REF2026-0908 Maanda-awe Mamathuntsha Tender Process Tender REF2026-0908 - Testing send back Review and Approve Tender Details 11/08/2026 Advertised":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=84259685-4161-4c06-8977-685aab16000c&todoid=63c5c658-5ab3-4eca-bca2-f4b1e350cfc6
            - img "search"
        - cell "REF2026-0908"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-0908 - Testing send back"
        - cell "Review and Approve Tender Details"
        - cell "11/08/2026"
        - cell
        - cell "Advertised"
      - row "search REF2026-1386 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1386 - testtttt Review and Approve Tender Details 06/07/2026 Submitted":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=9ba27f0d-f5e5-4860-bf77-a884f50d1ea9&todoid=baad9482-7c39-47b2-b789-9f4ed36abebc
            - img "search"
        - cell "REF2026-1386"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1386 - testtttt"
        - cell "Review and Approve Tender Details"
        - cell "06/07/2026"
        - cell
        - cell "Submitted"
      - row "search REF2026-1073 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1073 - tenderss Review and Approve Tender Details 03/07/2026 Submitted":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=b2178e15-e497-444d-b968-815943ad0d81&todoid=c94be1a9-f03c-4a12-8ff9-3e1820475e06
            - img "search"
        - cell "REF2026-1073"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1073 - tenderss"
        - cell "Review and Approve Tender Details"
        - cell "03/07/2026"
        - cell
        - cell "Submitted"
