...
- Name: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts >> TC-09 — Click on the ellipses on the Supplier Name field
- Location: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts:194:5
