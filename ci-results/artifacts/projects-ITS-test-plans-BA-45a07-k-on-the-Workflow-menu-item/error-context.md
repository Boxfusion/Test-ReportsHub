...
- Name: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts >> TC-02 — Click on the Workflow menu item
- Location: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts:28:5
...
Error: strict mode violation: getByRole('menuitem', { name: /workflow/i }).or(getByText(/workflow/i).first()) resolved to 2 elements:
    1) <div tabindex="-1" role="menuitem" aria-haspopup="true" aria-expanded="false" class="ant-menu-submenu-title" data-menu-id="rc-menu-uuid-76258-1-dhR5E82xtvBDZ-IPa-u5V" aria-controls="rc-menu-uuid-76258-1-dhR5E82xtvBDZ-IPa-u5V-popup">…</div> aka getByRole('menuitem', { name: 'deployment-unit Workflows' })
    2) <span class="nav-links-renderer is-parent-menu">Workflows</span> aka getByText('Workflows')

Call log:
  - Expect "toBeVisible" getByRole('menuitem', { name: /workflow/i }).or(getByText(/workflow/i).first()) with timeout 5000ms
    ...
    - generic [ref=e62]:
      ...
      - main [ref=e64]:
        - generic [ref=e66]:
          ...
          - generic [ref=e68]:
            - generic [ref=e70]:
              - img "arrow-right" [ref=e71]
              - link [ref=e74] [cursor=pointer]:
                - /url: https://docs.shesha.io/docs/get-started/tutorial/the-basics/
                - heading "Build your first app" [level=4] [ref=e75]
              - paragraph [ref=e76]: A quickstart guide to help you build an app using Shesha
            - generic [ref=e78]:
              - img "arrow-right" [ref=e79]
              - link [ref=e82] [cursor=pointer]:
                - /url: https://docs.shesha.io/docs/get-started/Introduction
                - heading "Documentation" [level=4] [ref=e83]
              - paragraph [ref=e84]: A deeper dive into core Shesha functionality
            - generic [ref=e86]:
              - img "arrow-right" [ref=e87]
              - link [ref=e90] [cursor=pointer]:
                - /url: https://docs.shesha.io/docs/fundamentals/how-to-change-home-page/
                - heading "How to change landing page" [level=4] [ref=e91]
              - paragraph [ref=e92]: Change your landing page to a custom page
  - alert [ref=e93]
```
