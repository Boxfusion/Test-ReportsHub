...
- Name: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts >> TC-16 — Select Service Delivery Date from the date picker
- Location: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts:376:5
