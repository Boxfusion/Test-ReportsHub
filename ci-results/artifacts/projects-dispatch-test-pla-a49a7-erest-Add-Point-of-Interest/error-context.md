...
- Name: projects/dispatch/test-plans/administrative-functions/admin-functions-crud.spec.ts >> Administrative Functions — Create/Edit verification (2026-06-17 session) >> Point of Interest >> Add Point of Interest
