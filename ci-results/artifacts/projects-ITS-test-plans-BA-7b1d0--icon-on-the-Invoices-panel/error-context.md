...
- Name: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts >> TC-12 — Click Cancel icon on the Invoices panel
- Location: projects/ITS/test-plans/BAS/register-and-upload-invoice.spec.ts:273:5
...
Call log:
  - waiting for locator('[class*="invoices"] button[class*="add"], [aria-label*="add invoice"]').first().or(getByRole('button', { name: /add/i }).first())
      ...
      - main [ref=e133]:
        - generic [ref=e138]:
          - generic [ref=e139]:
            ...
            - generic [ref=e150]:
              - generic [ref=e151]: "Ref No: PAY13626/2026"
