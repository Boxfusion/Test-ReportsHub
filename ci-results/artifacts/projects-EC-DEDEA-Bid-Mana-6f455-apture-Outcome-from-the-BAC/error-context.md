...
- Name: projects/EC-DEDEA-Bid-Management/test-plans/tender-process/ecdedea-tender-process.spec.ts >> ECDEDEA-TP — EC DEDEA Bid Management (Tender Process) >> TC-13: Capture Outcome from the BAC
- Location: projects/EC-DEDEA-Bid-Management/test-plans/tender-process/ecdedea-tender-process.spec.ts:704:7
...
Locator: getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Capture outcome from the BAC' }).first()
Expected: visible
Timeout: 30000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Capture outcome from the BAC' }).first() with timeout 30000ms
  - waiting for getByRole('row').filter({ hasText: 'ECDEDEA Automated Tender' }).filter({ hasText: 'Capture outcome from the BAC' }).first()
  ...
  - table:
    - row "Ref No Initiator Type Name Action Required Received Date Target Date Status":
      ...
      - columnheader "Status":
        ...
        - separator
    - rowgroup:
      - row "search REF2026-1187 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1187 - sending back for re-evaluation testing Capture outcome from the BAC 13/08/2026 Adjudicate In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=48cdf331-88f4-4310-a332-3c2cc1dd6617&todoid=1166d4f6-c70d-4cd8-88ed-87825636784e
            - img "search"
        - cell "REF2026-1187"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1187 - sending back for re-evaluation testing"
        - cell "Capture outcome from the BAC"
        - cell "13/08/2026"
        - cell
        - cell "Adjudicate In Progress"
      - row "search REF2026-2038 Maanda-awe Mamathuntsha Tender Process Tender REF2026-2038 - Send back for re-evaluation Capture outcome from the BAC 20/07/2026 Adjudicate In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=eedcb501-cc6e-46d7-a20f-4b456d942df3&todoid=10586474-1e0f-41c3-9170-781b81b7da12
            - img "search"
        - cell "REF2026-2038"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-2038 - Send back for re-evaluation"
        - cell "Capture outcome from the BAC"
        - cell "20/07/2026"
        - cell
        - cell "Adjudicate In Progress"
      - row "search REF2026-1377 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1377 - testt2 Capture outcome from the BAC 06/07/2026 Adjudicate In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=90375b14-eed5-4d34-9b84-5b55f183d0c5&todoid=ad5909b6-4db0-4cab-b3be-f4d0bf4da951
            - img "search"
        - cell "REF2026-1377"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1377 - testt2"
        - cell "Capture outcome from the BAC"
        - cell "06/07/2026"
        - cell
        - cell "Adjudicate In Progress"
      - row "search REF2026-1332 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1332 - Re-evaluation send back Capture outcome from the BAC 06/07/2026 Adjudicate In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=6d01632d-1cef-4874-8d35-ae96f757323d&todoid=482fa001-69c6-4bd4-95ec-2b31d6212eca
            - img "search"
        - cell "REF2026-1332"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1332 - Re-evaluation send back"
        - cell "Capture outcome from the BAC"
        - cell "06/07/2026"
        - cell
        - cell "Adjudicate In Progress"
      - row "search REF2026-1044 Maanda-awe Mamathuntsha Tender Process Tender REF2026-1044 - Capture order details step Capture outcome from the BAC 30/06/2026 Adjudicate In Progress":
        - cell "search":
          - link "search":
            - /url: /shesha/workflow-action?id=20a62209-81d5-49f5-8fa1-1896efeaa20f&todoid=b6227c0e-f850-4c2e-b22d-d03b657d8c43
            - img "search"
        - cell "REF2026-1044"
        - cell "Maanda-awe Mamathuntsha"
        - cell "Tender Process"
        - cell "Tender REF2026-1044 - Capture order details step"
        - cell "Capture outcome from the BAC"
        - cell "30/06/2026"
        - cell
        - cell "Adjudicate In Progress"
